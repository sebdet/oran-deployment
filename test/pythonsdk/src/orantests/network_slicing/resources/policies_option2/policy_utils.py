...
BASE_DIR = os.path.dirname(os.path.dirname(__file__)) + '/policies_option2/'
print(BASE_DIR)

HEADERS = {'Content-Type': 'application/json'}
AUTH = requests.auth.HTTPBasicAuth('policyadmin', 'zb!XztG34')
...
def generate_nssi_policies(jinja_args):
    ...
    print('generate_nssi_policies gen_dir:' + gen_dir)
...
if action == "generate_nssi_policies":
    ...
    policy_dir = BASE_DIR + sys.argv[2]
    print("create_and_push_policies:"+policy_dir)
