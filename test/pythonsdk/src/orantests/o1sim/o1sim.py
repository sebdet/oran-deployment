...
class O1sim(OnapService):
        ...
        @classmethod
        def get_fault_status(cls,fault_node,basic_auth: Dict[str, str]) -> dict:
            """
        ...
        @classmethod
        def create_array_of_devices(cls, url):
            ...
            devices = ["o-ru-11211","o-ru-112211", "o-ru-11222", "o-ru-11223", "o-du-1121", "o-du-1122", "topology-server"]

            for device in devices:
                OranSdnc.get_devices(device)
